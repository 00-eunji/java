...
public class Sample {
	...
	public static void main(String[] args) {
		...
		result6 = !(num1>10) && (num2<5); // ! <- 부정 괄호 안에 있는 값을 바꿔준다
		System.out.println(result6);
	
		int age=23;
		char gender='M';
		//20세 이상이면 입장 가능 아니면 불가능 출력
		if((age>=20) && (gender=='M'))		{
		...
		grade=60;
		System.out.println(grade);
		grade -=2;// grade + 3; 과 결과가 같음
		System.out.println(grade); // 60+2  -> 62 출력
